...
function ToDoApp() {
    ...
    function completeTask(index) {
        ...
        var updatedTasks = tasks.filter(function (_, i) {
            return i !== index;
        });
        var updatedCompleted = [...completedTasks, deletedTask].slice(-5);
        setTasks([...updatedTasks]);
                ...
                React.createElement(
                    "button",
                    {
                        onClick: function (event) {
                            var indexToDelete = parseInt(event.target.getAttribute("data-index"), 10);
    ...
    return React.createElement(
        ...
        completedTasks.length > 0 && React.createElement(
            ...
            React.createElement(
                "ul",
                null,
                completedTasks.map(function (task, index) {
                    return React.createElement(
                        "li",
                        {
                            key: index,
